...
export const createModal = (title, content, footer, hasCloseBtn) => {
    ...
    const modal = wire()`
        <div class="tny-modal">
            <div class="tny-modal-header">
                ...
                ${hasCloseBtn ? `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="white" class="close-icon" onclick=${close}>
