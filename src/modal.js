...
export const createModal = (title, content, footer, noCloseBtn) => {
    ...
    const modal = wire()`
        <div class="tny-modal">
            <div class="tny-modal-header">
                ...
                ${noCloseBtn ? "" : wire()`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="white" class="close-icon" onclick=${close}>
            ...
            <div class="tny-modal-body">${content}</div>
            <div class="tny-modal-footer">${footer}</div>
        </div>`
    return {
